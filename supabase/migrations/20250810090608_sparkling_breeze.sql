/*
  ...
  2. Security
    ...
    - Add policy for authenticated users to create comments (must own the comment)
  ...
  3. Indexes
    - Index on `research_note_id` for efficient comment retrieval by note
    - Index on `user_id` for efficient comment retrieval by user
